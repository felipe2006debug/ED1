...
Escreva uma função que obtêm o espelho de uma árvore, ou seja, troca a sub-árvore direita pela
sub-árvore esquerda de todos os nós da árvore.
*/
#include <stdio.h>
#include <stdlib.h>
