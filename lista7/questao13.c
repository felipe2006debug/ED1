...
Uma ABB e estritamente binária se todos os nós da árvore tem 2 filhos. Implemente uma função que
verifica se uma ABB é estritamente binária.
*/
#include <stdio.h>
#include <stdlib.h>
...
int main(){
  ...
  //Descomente para arvore nao estritamente binaria. 
  /*insereABB(raiz, 10);
  insereABB(raiz, 99);
  insereABB(raiz, 2);
  insereABB(raiz, 67);
